...
def send_welcome(message):
    ...
    bot.send_message(username, "Hello {username} welcome to the Story Generator Bot! Please send me the hero's name.")

def button_container(message):
    keyboard = types.ReplyKeyboardMarkup(row_width=2)
    button_1 = types.KeyboardButton('Button 1')
    button_2 = types.KeyboardButton('Button 2')

    keyboard.add(button_1,button_2)
    bot.send_message(message.chat.id,"Choose an option", reply_markup=)
