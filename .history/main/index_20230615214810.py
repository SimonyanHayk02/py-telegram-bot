...
def generate_story(message):
    ...
    А теперь сгенерируй сказку с персонажем {message.json[]} .Но перед тем как сказать тебе етого персонажа мне нужно чтобы ты проверил сушествует ли такой персонаж или нет если сушествует то ты должен
