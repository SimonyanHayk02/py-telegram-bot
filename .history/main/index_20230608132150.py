...
def generate_story(message):
    ...
    chat_response = openai.Completion.create(
     ...
     значение.Но не слишком большое чтобы ты смог отправить его сразу.и пожалуйста сделай перевоИ мне не нужны обзацы чтобы не потерять слов. Например сказка про соника.
