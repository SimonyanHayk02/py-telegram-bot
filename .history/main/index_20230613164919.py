...
def generate_story(message):
    ...
    дать мне сгенерированну сказку а если нет сказать что такого персонажа не сушествует.
      ...
      Ты генерируешь сказки для детей от 4 до 12 лет.А теперь сгенерируй сказку сперсонажем Саб Зиро.Мне нужно чтобы у сказки было смысловое начало и окончание.
