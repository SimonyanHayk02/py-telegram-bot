...
def generate_story(message):
    ...
    chat_response = openai.Completion.create(
        model="text-davinci-003"{message.text},
        prompt=("""
     ...
     значение.Но не слишком большое чтобы ты смог отправить его сразу.И мне не нужны обзацы чтобы не потерять слов. Например сказка про соника.
