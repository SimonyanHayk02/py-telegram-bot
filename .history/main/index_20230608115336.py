...
def generate_story(message):
    ...
    chat_response = openai.Completion.create(
        ...
        prompt=("я хочу чтобы ты стал моим создателем промптов.Мне нужно чтобы ты сгенерировал для детей сказку
                 с написанной мной персонажем . Но чтобы оно имело смысловое значение.Но не слишком большое чтобы ты смог отправить его сразу.А теперь сгенерируй сказку сперсонажем" message.text),
        temperature=1,
        max_tokens=2048
    )
