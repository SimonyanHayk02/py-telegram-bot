...
def generate_story(message):
    ...
    Но ты должен проверить етих персонажей из фильмов, мултьтфильмов,сказок,знаменитых игр и так далее.
    Ты генерируешь сказки для детей от 4 до 12 лет.А теперь сгенерируй сказку сперсонажем {message.text}.Мне нужно чтобы у сказки было смысловое начало и окончание.
                """ ,
        temperature=1,
        max_tokens=2048
    )
